...
CREATE TABLE `comment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '评论的数据表,添加parent_id和root_id字段使其支持评论嵌套' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户的数据表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_follow`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户关注关系的数据表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_initiate_dynamic`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '动态数据表.用于监视用户的动作' ROW_FORMAT = Dynamic;
